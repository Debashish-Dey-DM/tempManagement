...
const HomePayments = () => {
  ...
  const getData = async () => {
    setState(true);
    await axios
      .get(`/api/Payments/getPaymentByUser/${id}`)
      .then((res) => {
      ...
      {state ? (
        ...
        >
          <Container className={`${commonStyles.commonForm} pt-3`}>
            ...
            <Row>
              <Col md={5}>
              <h6>
                  পরিশোধ : {new Date(user?.clearUpto).toLocaleDateString("en-US", {
                    month: "short",
                    year: "numeric",
                  })} পর্যন্ত
                </h6>
            ...
            <div>
              ...
              <thead>
                  <tr>
                    <th>তারিখ <small className="fw-lighter">(dd-mm-yyyy)</small></th>
                    <th>পরিমান</th>
                    <th>রিসিট</th>
                  </tr>
                </thead>
                ...
                <div className="printArea py-3 px-5" ref={componentRef}>
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <div>
                      ...
                      <h6>ঘর নংঃ {homeID && (homeID).toLocaleString("bn-BD")}</h6>
                      <h6>
                        তারিখঃ
                  ...
                  <div className="mt-3 lh-lg">
                    ...
                    ভাড়া, মাসিক ভাড়ার পরিমান <span className="fw-bold text-decoration-underline">
                      {rent ? rent.toLocaleString("bn-BD") : ""} টাকা_
                    </span> মোট আদায় কৃত ভাড়ার
                    পরিমান_
                    <span className="fw-bold text-decoration-underline">
                      {singlePayment.amount ? singlePayment.amount.toLocaleString("bn-BD") : ""} টাকা_
                    </span>
                    (কথায়)
                    <span className="fw-bold text-decoration-underline">
                      _
        ...
        <div className="d-flex align-items-center justify-content-center mt-5">
          <div className="text-center">
            <h1 className="mb-4">আবাসন তথ্য পেতে চান? </h1>
