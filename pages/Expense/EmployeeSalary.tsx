...
const EmployeeSalary = () => {
  ...
  const [pay, setPay] = useState({
    ...
    const mount = async () => {
    await axios
      .get("http://localhost:3000/api/Expenses/getPayments/EmployeeSalary")
      .then((res) => {
 ...
 return (
    ...
    >
      ...
      >
        <h3 className="mb-4 alert alert-primary">মন্দির কার্যে সংশ্লিষ্টদের সম্মানি-বেতন-ভাতাদি</h3>
        <Row className="row">
